var includes = [
    ...
    // reference services
    '/app/services/subjectService.js',
...
define(includes, function(app){
    ...
    app.config(['$routeProvider', 'routeResolverProvider', 'ckServiceResolverProvider', 'ckResourceResolverProvider',
        '$controllerProvider', '$compileProvider', '$filterProvider', '$provide',

        function ($routeProvider, routeResolverProvider, ckServiceResolverProvider, ckResourceResolver,
                  $controllerProvider, $compileProvider, $filterProvider, $provide) {
