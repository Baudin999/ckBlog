...
define([], function() {
    ...
    var factory = function(module) {
         ...
         */
        module.directive('ckMultilineM', function() {
            ...
            return {
                restrict: 'E',
                templateUrl: "/app/templates/ck-multiline-m.html",
                scope: {
                    cssClass: '@',
                    name: '@',
                    width: '@',
                ...
                controller: function($rootScope, $scope, $element) {
                    ...
                    mergedOptions.height = $scope.height || mergedOptions.height;
                    mergedOptions.width = $scope.width || mergedOptions.width || 'col';
                    ...
                    $scope.reset = function() {
                        if ($scope.options.allowClear) {
                            ...
                            $http.get('http://loripsum.net/api/plaintext').then(function(lorem) {
                                $scope.data = lorem;
                            });
                        }
                    };
                    ...
                    $element.delegate('*', 'focus blur', function() {
                        var inputControl = $(this).find('.input-control');
                        inputControl.toggleClass("focus");
                        if (inputControl.hasClass('focus')) {
                    ...
                    if ($scope.options.height) {
                        $element.find('.input-control').css('height', $scope.options.height);
                    }
                }
            };
        });
